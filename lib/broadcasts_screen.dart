        ...
        builder: (context, snapshot) {
          ...
          for (final doc in docs) {
            ...
            if (_searchQuery.isNotEmpty) {
              ...
              final matchesSender = senderName.toLowerCase().contains(_searchQuery);
              final matchesMessage = message.contains(_searchQuery);
              if (!matchesSender && !matchesMessage) continue;
            }
